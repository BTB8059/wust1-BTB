...
namespace WebApplication2
{
    public partial class check : System.Web.UI.Page
    {
        ...
        protected void DropDownList_keshifei_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void chazhao_Click(object sender, EventArgs e)
        {
            ...
            //Session["11"] = jiaoshouxueke1.SelectedItem.ToString() + jiaoshouxueke2.SelectedItem.ToString();
            //Response.Write(Session["11"].ToString());
