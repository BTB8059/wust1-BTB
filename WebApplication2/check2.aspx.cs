...
namespace WebApplication2
{
    public partial class check2 : System.Web.UI.Page
    {
        ...
        protected void chazhao_Click(object sender, EventArgs e)
        {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            Session["1"] = DropDownList_keshifei.SelectedItem.ToString();

            Session["2"] = shukequyu1.SelectedItem.ToString() + shukequyu2.SelectedItem.ToString();

            Session["3"] = jiaoshouxueke1.SelectedItem.ToString() + jiaoshouxueke2.SelectedItem.ToString();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from TutorTable where TeachCost=@TeachCost  and TeachArea=@TeachArea and  TeachSubject=@TeachSubject ", conn);
                cmd.Parameters.Add("@TeachCost", SqlDbType.NChar);
                cmd.Parameters.Add("@TeachArea", SqlDbType.NChar);
                cmd.Parameters.Add("@TeachSubject", SqlDbType.NChar);
                cmd.Parameters[0].Value = Session["1"].ToString();
                cmd.Parameters[1].Value = Session["2"].ToString();
                cmd.Parameters[2].Value = Session["3"].ToString();
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
                    Session["家教信息"] = "教员编号： " +dr[0].ToString() +"<br/>"+"姓名："+ dr[6].ToString() + "<br/>" + "性别：" + dr[8].ToString() + "<br/>" + "地址：" + dr[16].ToString() + "<br/>" + "联系电话：" + dr[3].ToString() + "<br/>" + "邮箱：" + dr[2].ToString() + "<br/>" + "机构：" + dr[4].ToString() + "<br/>" + "教授程度：" + dr[7].ToString() + "<br/>" + "教龄：" + dr[11].ToString() + "<br/>" + "教课时间：" + dr[12].ToString() +"    "+ dr[13].ToString() + "<br/>" + "教课薪资：" + dr[14].ToString() + "<br/>" + "授课区域：" + dr[15].ToString() + "<br/>" + "教授科目：" + dr[17].ToString() + "<br/>" + "自我评价：" + dr[18].ToString() + "<br/>" + "个性签名：" + dr[9].ToString() + "<br/>" + "<br/>" + "<br/>" + "<br/>";

                    Response.Redirect("ShowCheck.aspx");
